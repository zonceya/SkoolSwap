...
import za.co.skoolswap.data.remote.models.response.home.EssentialsSectionsDto
import za.co.skoolswap.data.remote.models.response.home.HomeRecommendationResponse
import za.co.skoolswap.data.remote.models.response.home.HomeSectionDto
import za.co.skoolswap.data.remote.models.response.home.RankedItemDto
import za.co.skoolswap.data.remote.models.response.home.RecentRecommendationResponse
import za.co.skoolswap.data.remote.models.response.home.RecentSectionDto
import za.co.skoolswap.data.remote.models.response.home.SportRecommendationResponse
import za.co.skoolswap.data.remote.models.response.home.SportSectionDto
import za.co.skoolswap.data.remote.models.response.home.UniformRecommendationResponse
import za.co.skoolswap.data.remote.models.response.home.UniformSectionDto
import za.co.skoolswap.domain.model.*
import za.co.skoolswap.domain.model.homefeed.EssentialsSections
import za.co.skoolswap.domain.model.homefeed.HomeFeed
import za.co.skoolswap.domain.model.homefeed.RecentFeed
import za.co.skoolswap.domain.model.homefeed.RecentSection
import za.co.skoolswap.domain.model.homefeed.Section
import za.co.skoolswap.domain.model.homefeed.SportFeed
import za.co.skoolswap.domain.model.homefeed.SportSection
import za.co.skoolswap.domain.model.homefeed.UniformFeed
import za.co.skoolswap.domain.model.homefeed.UniformSection
...
fun RankedItemDto.toDomain(): Item {
    ...
    return Item(
        ...
        viewCount = viewCount,
        relevance = relevance ?: "other"

        )
}
// RecommendationMapper.kt - update HomeSectionDto.toDomain()
...
fun EssentialsSectionsDto.toDomain(): EssentialsSections {
    return EssentialsSections(
        ...
        stationery = stationery?.map { it.toDomain() } ?: emptyList()
    )
}
...
// RecommendationMapper.kt - update getAllItems()
    ...
    sections.forEach { section ->
        when (section) {
            ...
            is Section.Essentials -> {
                ...
                allItems.addAll(section.sections.stationery)  // ✅ ADD THIS
            }
        }
    }
