...
import za.co.skoolswap.data.remote.models.response.reference.BrandDto
import za.co.skoolswap.data.remote.models.response.reference.GenderDto
import za.co.skoolswap.data.remote.models.response.reference.MainCategoryDto
import za.co.skoolswap.data.remote.models.response.reference.ProvinceDto
import za.co.skoolswap.data.remote.models.response.reference.SchoolDto
import za.co.skoolswap.data.remote.models.response.reference.SubCategoryDto
import za.co.skoolswap.data.remote.models.response.reference.TownDto
...
data class ItemDto(
    ...
    @SerializedName("meta") val meta: ItemMetaDto?,
    @SerializedName("images") val images: List<String>? = emptyList(),
    @SerializedName("image") val image: String?,
    @SerializedName("cover_photo") val coverPhoto: String?,
    @SerializedName("shop") val shop: ItemShopDto?,
    ...
    @SerializedName("town") val town: TownDto?,
    @SerializedName("province") val province: ProvinceDto?,
    @SerializedName("gender") val gender: GenderDto?,
    @SerializedName("main_category") val mainCategory: MainCategoryDto?,
    @SerializedName("sub_category") val subCategory: SubCategoryDto?,
...
data class AddImagesResponse(
    ...
    @SerializedName("failed_uploads") val failedUploads: List<String>?,
