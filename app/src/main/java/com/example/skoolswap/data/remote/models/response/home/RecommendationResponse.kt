...
data class EssentialsSectionsDto(
    @SerializedName("uniforms") val uniforms: List<RecommendationItemDto>,
    @SerializedName("sports") val sports: List<RecommendationItemDto>,
    @SerializedName("accessories") val accessories: List<RecommendationItemDto>
)
